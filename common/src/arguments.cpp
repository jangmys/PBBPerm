...
void arguments::readIniFile()
{
    ...
    strncpy(inst_name,reader.Get("instance", "instance", "UNKNOWN").c_str(),50);
    //printf("%s / %s\n",problem,inst_name);
...
//        printf("INIT\n");
        std::ifstream infile("./parameters/instances.data");
