...
// device variables common to all problems
...
__host__ __device__ enum counterID { exploringState, emptyState, initState };
__host__ __device__ enum ctrlID { toDo, gpuEnd, foundLeaf, bestCost };

// template <typename T>
// void
// setDeviceInt(const char * dev_symbol, const T _val)
// {
//     T val = _val;
//     gpuErrchk(cudaMemcpyToSymbol(dev_symbol, &val, sizeof(T)));
// }
