...
void bound_nqueens::boundChildren(int* schedule, const int limit1, const int limit2, int* costsBegin, int* costsEnd, int* prioBegin, int* prioEnd)
{
...
int bound_nqueens::evalSolution(int *permutation){
    int conflicts=0;
